...
public class Exp3{
    ...
    Exp3(List<Point3D> pnts){
        this.pnts = pnts;
    }

    Exp3(String fileName) throws FileNotFoundException{
        this.pnts = read(fileName);
    }

    //default constructor
    Exp3(String fileName, double eps, double minPnts) throws FileNotFoundException{
        this.pnts = read(fileName);
        this.eps = eps;
    ...
    public void findClusters(){
        ...
        NearestNeighborsKD NN = new NearestNeighborsKD(this.pnts);
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException{
        ...
        Exp3 db = new Exp3(fileName, eps, minPnts);

        NearestNeighborsKD nb = new NearestNeighborsKD(db.getPoints());
